...
This directory contains supporting files and notes for reproducing VARHAC estimator results using the original FORTRAN implementation. The files include simulated data, VARHAC output under various configurations, and Python scripts to parse and analyze the results.
